    ...
    return (
      <div className="skillListBackground">
        ...
        <div className="skillListContain">
          <h3 className="skillIntro">Software development is hard. Managing projects is hard. Working remotely is hard. Here are some things I'm good at, to help ease the pain.</h3>
